...
m = len(text2)
ob = Solution()
# lcs_len=ob.spaceOptimization(text1, text2, n, m)

lcs_len = ob.tabulation(text1, text2, n, m)

min_deletion = len(text1)-lcs_len
min_insertion = len(text2)-lcs_len

print(min_deletion+min_insertion)
